...
parser.add_argument('--frames', type=float, default=0.1,
                    help='expected number of frames per second for each client')
parser.add_argument('--ticks', type=int, default=100,
                    help='simulator ticks per second')
parser.add_argument('--length', type=float, default=1.0,
                    help='maximum length of a frame')
...
parser.add_argument('-s', '--silent', action='store_true', default=False, help='print only values')
